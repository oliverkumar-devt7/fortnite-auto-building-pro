#!/usr/bin/env python3
"""Fortnite-auto-building screen analysis tool with overlay and hotkeys."""
import argparse
import logging
import threading
import time
...
class Fortniteautobuildingpro:
 ...
 def start(self):
 log.info("fortnite-auto-building-pro starting...")
 ...
 self.overlay.close()
 self.hotkeys.stop()
 log.info("fortnite-auto-building-pro stopped")
...
def main():
 ...
 app = Fortniteautobuildingpro(args.config)
 app.start()
